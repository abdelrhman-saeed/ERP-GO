...
class ModuleController extends Controller
{
    ...
    public function install(Request $request)
    {
        ...
        // Check if the module.json exists inside the ZIP
        ...
        // Extract files directly to the target directory (without using temp folder)
        if ($zip->extractTo($extractPath)) {
            $zip->close(); // Close the ZIP file after extraction
            ...
            return error_res(__('Failed to extract files.'));
        }
    }
